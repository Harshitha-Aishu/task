        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-lg-4 col-md-8 mt-4">
                <form action="https://www.apponix.com/search" method="GET">
                    <input type="hidden" name="_token" value="lPkRK8f8Ws8zmPNKYKKzAXdEgdpFNHoQMByDPgnf">                    <input type="text" id="myInput" placeholder="Find The Courses" title="Type in a name" name="course">
                </form>
            </div>
                    ...
                    <div class="mobile-search">
                        <div class="search-wrapper">
                            ...
                            <div class="input-holder">
                                <form action="https://www.apponix.com/search" method="GET">
                                    <input type="hidden" name="_token" value="lPkRK8f8Ws8zmPNKYKKzAXdEgdpFNHoQMByDPgnf">                                    <input type="text" class="search-input inputsearch" id="myInputmobiles" placeholder="Find The Courses" title="Type in a name" name="course">
                                </form>
                        ...
                        <div class="box row">
                            ...
                            <div class="col-md-12 digital-mar-row p-0">
                                <div class="contact-right-cls p-md-3 p-3 contact-right-clshome" id="contact-home">
                                                                             ...
                                                                             <input type="hidden" name="_token" value="lPkRK8f8Ws8zmPNKYKKzAXdEgdpFNHoQMByDPgnf">                                        <!-- <input type="hidden" name="recaptcha" id="recaptcha"> -->
                                        
                                        <input type="hidden" name="country" value="india">
                                        <input type="hidden" name="location" value=" null">
										<input type="hidden" name="ipaddress" value="49.205.140.103">
